...
def norm_data(args):
    ...
    supported_datasets = ['LJSpeech-1.0', 'LJSpeech-1.1', 'M-AILABS', 'vctk_lj_format']
    ...
    if args.dataset.startswith('vctk_lj_format'):
        return [os.path.join(args.base_dir, 'vctk_lj_format')]
